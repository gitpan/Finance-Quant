# This Makefile is for the Finance::Quant extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Finance/Quant.pm]
#     AUTHOR => [q[Hagen Geissler <santex@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Finance::Quant]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Finance/Quant.pm]
...
MAKEMAKER   = /usr/local/share/perl/5.12.4/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = Finance/Quant
BASEEXT = Quant
PARENT_NAME = Finance
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Finance/Quant.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Finance/Quant.pm \
	lib/Finance/VGrep.pl

PM_TO_BLIB = lib/Finance/VGrep.pl \
	blib/lib/Finance/VGrep.pl \
	lib/Finance/Quant.pm \
	blib/lib/Finance/Quant.pm
...
DISTNAME = Finance-Quant
DISTVNAME = Finance-Quant-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Finance/Quant.pm $(INST_MAN3DIR)/Finance::Quant.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Finance-Quant' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Hagen Geissler <santex@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Finance-Quant",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Finance/VGrep.pl blib/lib/Finance/VGrep.pl \
	  lib/Finance/Quant.pm blib/lib/Finance/Quant.pm 
